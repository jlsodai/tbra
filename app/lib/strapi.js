export const homeData = {
  ...
  seo: {
    ...
    metaDescription:
      "Promoting exceptional, diverse talent to board and executive positions in Africa and across the globe. We are passionate about diversity and utilise it to achieve exceptional results for all our stakeholders.",
    keywords: "Executives in Africa, Board Recruitment",
    metaRobots: null,
    structuredData: null,
    metaViewport: null,
    canonicalURL: null,
...
export const aboutData = {
  ...
  intro: {
    ...
    Title: "Our Story",
    content:
      "TheBoardroom Africa officially launched in 2016, but in many ways, this community has been years in the making. My own journey navigating corporate ranks as a young executive inspired the desire to build what has now become Africa's most vibrant private community of executives.\n\nWhat started with a handful of executives across a few countries has now developed into a global movement for advancing board and executive leadership diversity more holistically.\n\nToday, TBrA is enhancing and amplifying the potential of Africa's exceptional leaders. We also support companies hoping to unlock the power of diversity and improve business performance by connecting them with talent. And we work with executives to equip them with the resources they need as they navigate their journeys in and outside the boardroom. We invite you to join us to build better boardrooms and more inclusive leadership spaces.",
    imageUrl:
...
export const execData = {
  ...
  Programmes: [
    ...
    {
      id: 6,
      title: "Certificate in Company Direction",
      date: "Quarter 1 2025",
      seatsRemaining: "30",
      // venue: "Virtual",
      imageUrl:
        "https://tbratest.my.canva.site/executive-development-page/images/128b157c5a41f2c2b630bbb9d2543b69.jpg",
      applyBtnUrl: "/open-doors-application?hideBanner=true",
      applyBtnTxt: "Register your interest",
      noSeats: true,
      // learnmoreBtnUrl: "/executive-programmes/open-doors",
      groupName: null,
    },
  ...
  },
  {
    ...
    attributes: {
      ...
      brochureInfo: {
        ...
        subsidyText:
          "The ESG Certificate Programme returns  in the first Quarter of 2025.  As we finalise dates please click the button below to  register your interest in being part of the programme and we will reach out to you soon with more information.",
...
export const membershipData = {
  ...
  community: {
    ...
    imageUrl:
      "https://res.cloudinary.com/dhhw72iwq/image/upload/v1718868802/membership-collage_yap8ze.png",
    link: null,
    btn: null,
    linkTitle: null,
    imageStyle: null,
