      ...
      {deactivate && (
        <div className="text-center fixed top-0 left-0 right-0 z-30">
          <div className="px-4 bg-dusk inline-block text-2xl text-white">
            <RxCaretDown className="mx-auto" onClick={() => handleBrochure()} />
          </div>
        </div>
      )}
      <section
        ...
        <div className="bg-dusk w-full py-8">
          ...
          <div className="container grid md:grid-cols-4 text-white gap-10 text-sm">
            <div className="">
              ...
              <p className="whitespace-pre-wrap">{brochureDetails.upcoming}</p>
            </div>
            <div className="">
              ...
              <div className="flex gap-2">
                {brochureDetails.brochureFormUrl && (
                  <PaperFormModal
                    ...
                    paperform={brochureDetails.brochureFormUrl}
                  />
                )}
