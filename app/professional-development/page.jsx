            ...
            <div className="py-8">
              ...
              <div className="mt-8" data-aos="fade-up" data-aos-delay="550">
                <div className="mt-12 flex gap-12 items-center">
                  <Link
                    href="/membership"
                    className="btn bg-transparent border border-white text-white font-normal text-xl"
                  >
          ...
          <div className="container grid md:grid-cols-2 gap-x-16 items-center">
            ...
            <div className="py-8 -md:mb-16">
              ...
              <p className="mt-8" data-aos="fade-up" data-aos-delay="350">
                ...
                who will provide customised advice to boost your visibility.
                They are also ready to apply those improvements on your behalf.
              </p>
          ...
          <div className="md:container grid md:grid-cols-2 gap-x-16">
            ...
            <div className="px-8 py-16 md:p-16 flex flex-col justify-center md:h-screen md:max-h-[800px]">
              ...
              <p className="mt-8" data-aos="fade-up" data-aos-delay="350">
                ...
                specialists will transform your distinct viewpoints into
                engaging opinion articles and LinkedIn posts that position you
                as a top voice, and leading authority in your field.
              </p>
              <div className="mt-8" data-aos="fade-up" data-aos-delay="550">
                <Link
        ...
        <section id="cv" className="bg-[#F4F1EC] flex flex-col justify-end">
          ...
          <div className="md:container grid md:grid-cols-3 items-center md:mt-24">
            ...
            >
              ...
              <p className="mt-8">
                Stand out when applying for executive roles with a
                professionally crafted CV. Our hour-long CV consultation
                uncovers strengths and guides you through areas for improvement.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="mt-8">
                Elevate your profile further with an intensive 3-hour makeover
                led by an Executive Search expert, leaving you with an expertly
